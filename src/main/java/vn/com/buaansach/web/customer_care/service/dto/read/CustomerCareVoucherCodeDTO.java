...
public class CustomerCareVoucherCodeDTO extends AuditDTO {
    ...
    public CustomerCareVoucherCodeDTO(VoucherCodeEntity voucherCodeEntity, VoucherEntity voucherEntity, VoucherTimeConditionEntity timeConditionEntity, VoucherUsageConditionEntity usageConditionEntity, VoucherStoreConditionEntity storeConditionEntity) {
        assignProperty(voucherCodeEntity, voucherEntity);
