package vn.com.buaansach.web.admin.repository.user.impl;
...
public class CustomAuditEventRepository implements AuditEventRepository {
    ...
    public CustomAuditEventRepository(AdminPersistenceAuditEventRepository adminPersistenceAuditEventRepository,
    ...
    public List<AuditEvent> find(String principal, Instant after, String type) {
        Iterable<PersistentAuditEvent> persistentAuditEvents =
                adminPersistenceAuditEventRepository.findByPrincipalAndAuditEventDateAfterAndAuditEventType(principal, after, type);
    ...
    public void add(AuditEvent event) {
        if (!AUTHORIZATION_FAILURE.equals(event.getType()) &&
            ...
            adminPersistenceAuditEventRepository.save(persistentAuditEvent);
        }
    }
