...
@Data
@NoArgsConstructor
public class AdminSaleDTO extends AuditDTO {
    private UUID guid;
    ...
    public AdminSaleDTO(SaleEntity entity) {
        updateAttribute(entity);
    }

    public AdminSaleDTO(SaleEntity entity, SaleTimeConditionEntity timeCondition) {
        updateAttribute(entity);
