...
public class AdminVoucherInventoryResource {
    ...
    public AdminVoucherInventoryResource(AdminVoucherInventoryService adminVoucherInventoryService) {
        this.adminVoucherInventoryService = adminVoucherInventoryService;
    }
