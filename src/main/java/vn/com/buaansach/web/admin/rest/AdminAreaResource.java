...
public class AdminAreaResource {
    ...
    public ResponseEntity<AdminAreaDTO> createArea(@Valid @RequestBody AdminCreateAreaDTO payload) {
        log.debug("REST request from [{}] to create [{}] : [{}]", SecurityUtils.getCurrentUserLogin(), ENTITY_NAME, payload);
    ...
    public ResponseEntity<AdminAreaDTO> updateArea(@Valid @RequestBody AdminAreaDTO payload) {
        log.debug("REST request from [{}] to update [{}] : [{}]", SecurityUtils.getCurrentUserLogin(), ENTITY_NAME, payload);
    ...
    public ResponseEntity<List<AdminAreaDTO>> getListAreaByStore(@PathVariable String storeGuid) {
        log.debug("REST request from [{}] to list [{}] by store : [{}]", SecurityUtils.getCurrentUserLogin(), ENTITY_NAME, storeGuid);
    ...
    public ResponseEntity<Void> deleteArea(@PathVariable String areaGuid) {
        log.debug("REST request from [{}] to delete [{}] : [{}]", SecurityUtils.getCurrentUserLogin(), ENTITY_NAME, areaGuid);
