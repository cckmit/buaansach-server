...
import vn.com.buaansach.web.guest.service.GuestStorePayRequestService;
...
public class GuestStorePayRequestResource {
    ...
    private final GuestStorePayRequestService guestStorePayRequestService;
    ...
    public ResponseEntity<GuestStorePayRequestDTO> sendRequest(@RequestBody GuestStorePayRequestDTO payload){
        ...
        return ResponseEntity.ok(guestStorePayRequestService.sendRequest(payload));
    }
    ...
    public ResponseEntity<GuestStorePayRequestDTO> getByOrderGuid(@PathVariable String orderGuid){
        ...
        return ResponseEntity.ok(guestStorePayRequestService.getByOrderGuid(orderGuid));
    }
}
