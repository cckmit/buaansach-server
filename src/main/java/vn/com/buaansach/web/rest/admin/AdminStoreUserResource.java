...
import vn.com.buaansach.model.dto.manipulation.AddStoreUserDTO;
import vn.com.buaansach.model.dto.manipulation.CreateOrUpdateStoreUserDTO;
...
public class AdminStoreUserResource {
     ...
     */
    @PostMapping("/add")
    public ResponseEntity<StoreUserDTO> addStoreUser(@Valid @RequestBody AddStoreUserDTO payload) {
