...
import vn.com.buaansach.web.common.repository.CommonFileRepository;
...
public class FileService {
    ...
    public FileService(CommonFileRepository commonFileRepository) {
    ...
    public InputStreamResource downloadFile(HttpServletResponse response, String guid) throws IOException {
        Optional<FileEntity> optional = commonFileRepository.findOneByGuid(UUID.fromString(guid));
    ...
    public void deleteByUrl(String fileUrl) {
        ...
        commonFileRepository.findOneByUrl(fileUrl).ifPresent(fileEntity -> {
            File file = new File(fileEntity.getLocalUrl());
            if (file.exists()) file.delete();
            commonFileRepository.delete(fileEntity);
        });
    }
