...
import vn.com.buaansach.web.general.service.MailService;
import vn.com.buaansach.web.general.service.UserService;
import vn.com.buaansach.web.general.service.dto.read.JwtTokenDTO;
import vn.com.buaansach.web.general.service.dto.read.UserDTO;
import vn.com.buaansach.web.general.service.dto.write.LoginRequestDTO;
import vn.com.buaansach.web.general.service.dto.write.PasswordResetDTO;
import vn.com.buaansach.web.general.service.dto.write.UpdateAccountDTO;
import vn.com.buaansach.web.general.service.dto.write.UserPasswordChangeDTO;
...
public class GeneralUserResource {
    ...
    private final Logger log = LoggerFactory.getLogger(GeneralUserResource.class);
    ...
    public ResponseEntity<UserDTO> getUserInfo() {
        ...
        return generalUserRepository.findOneByUserLoginIgnoreCase(SecurityUtils.getCurrentUserLogin())
    ...
    public ResponseEntity<UserDTO> getAccountInfoByLogin(@PathVariable String userLogin) {
        ...
        return generalUserRepository.findOneByUserLoginIgnoreCase(userLogin)
                .map(userEntity -> ResponseEntity.ok(new UserDTO(userEntity)))
                .orElseThrow(() -> new NotFoundException(ErrorCode.USER_NOT_FOUND));
    }
