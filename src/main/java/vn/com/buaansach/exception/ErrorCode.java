...
public enum ErrorCode {
    ...
    STORE_NOTIFICATION_NOT_FOUND, USER_PROFILE_NOT_FOUND, SALE_NOT_FOUND, INVALID_SALE_TIME_CONDITION, SALE_DISABLED, SALE_NOT_STARTED, SALE_ENDED, STORE_SALE_NOT_FOUND, STORE_SALE_DISABLED,
}
